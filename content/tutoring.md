...
<p class="eyebrow">Private lessons over Zoom</p>
...
| **Java & AP Computer Science A** | Object-oriented programming, algorithms, debugging, and course support |
| **AP Computer Science Principles** | Programming, data, algorithms, computer systems, networks, and the impact of computing |
| **C++** | Programming fundamentals, data structures, and systems concepts |
...
### Is this a class or one-on-one tutoring?

Tutoring is one-on-one. That makes it possible to adjust the pace, examples, and projects to one learner rather than asking them to keep up with a group curriculum.
...
I can help a student understand the concepts, interpret errors, and develop a solution process. I do not simply complete graded work for them—the point is for the student to leave able to do more on their own.

### How much does tutoring cost?

I discuss rates directly with each family because the arrangement can vary with the number of students and how often we meet. A regular or multi-session arrangement may have a lower per-session rate. Email me with what you have in mind and I’ll explain the options before you commit to anything.

### What equipment is needed?

A computer that can run Zoom and the tools used for the chosen language, plus a reliable internet connection. Scratch runs in a web browser. I can discuss the setup for other languages before the first lesson.
